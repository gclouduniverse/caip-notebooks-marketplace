...
const notebooks: NotebookProps[] = [
  {
    ...
    text: `Latest build of JupyterLab2 with pre-configured debugger for Python and TensorFlow 2.1.`,
    author: "Viacheslav Kovalevskyi",
    lastUpdateDate: new Date(2020, 4, 19),
    deploymentCode: "jupyterlab2",
    readMore:
      "https://github.com/gclouduniverse/caip-notebooks-marketplace/wiki/JupyterLab2-Notebooks-Solution"
  },
  {
    id: "2",
